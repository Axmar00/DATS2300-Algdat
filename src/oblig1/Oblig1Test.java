...
public class Oblig1Test {
    ...
    void oppgave1() {
        ...
        int[] tom = {};
        try {
            Oppgave1.maks(tom);  // kaller maks-metoden
        } catch (Exception e) {
            unntak = true;
        ...
        int[] c = {5, 4, 3, 2, 1};
        int[] d = {1, 2, 3, 4, 5};
        if (Oppgave1.maks(a) != 3 || Oppgave1.maks(b) != 8 ||
                Oppgave1.maks(c) != 5 || Oppgave1.maks(d) != 5) {
        ...
        if (Oppgave1.ombyttinger(a) != 5 || Oppgave1.ombyttinger(b) != 0
                || Oppgave1.ombyttinger(c) != 7 || Oppgave1.ombyttinger(d) != 6) {
    ...
    void oppgave2() {
        ...
        try {
            Oppgave2.antallUlikeSortert(a);  // kaller metoden
            Oppgave2.antallUlikeSortert(b);  // kaller metoden
        } catch (Exception e) {
            System.out.println
        ...
        try {
            Oppgave2.antallUlikeSortert(c);  // kaller metoden
        } catch (Exception e) {
            unntak = true;
        ...
        if (Oppgave2.antallUlikeSortert(a) != 0
                || Oppgave2.antallUlikeSortert(b) != 1
                || Oppgave2.antallUlikeSortert(d) != 1
                || Oppgave2.antallUlikeSortert(e) != 7
                || Oppgave2.antallUlikeSortert(f) != 7) {
    ...
    void oppgave3() {
        ...
        try {
            Oppgave3.antallUlikeUsortert(a);  // kaller metoden
            Oppgave3.antallUlikeUsortert(b);  // kaller metoden
        } catch (Exception ex) {
            System.out.println
        ...
        if (Oppgave3.antallUlikeUsortert(a) != 0
                || Oppgave3.antallUlikeUsortert(b) != 1
                || Oppgave3.antallUlikeUsortert(c) != 1
                || Oppgave3.antallUlikeUsortert(d) != 6
                || Oppgave3.antallUlikeUsortert(e) != 5
                || Oppgave3.antallUlikeUsortert(f) != 3) {
    ...
    void oppgave4() {
        ...
        try {
            Oppgave4.delsortering(a);  // kaller metoden
        } catch (Exception ex) {
            System.out.println
    ...
    void oppgave5() {
        ...
        try {
            Oppgave5.rotasjon(a);  // kaller metoden
        } catch (Exception e) {
            System.out.println
   ...
   /* @org.junit.jupiter.api.Test
    void oppgave7() {
        ...
        try {
            s = Oppgave7.flett("", "");  // kaller metoden
        } catch (Exception e) {
        ...
        try {
            s = Oppgave7.flett("", "AB");  // kaller metoden
        } catch (Exception e) {
            System.out.println(e);
            System.out.println
        ...
        s = Oppgave7.flett("ACEGIK", "BDFHJLMN");
        ...
        try {
            s = Oppgave7.flett(a);  // kaller metoden
        } catch (Exception e) {
            System.out.println(e);
            System.out.println
        ...
        try {
            s = Oppgave7.flett("", "ABC", "");  // kaller metoden
        } catch (Exception e) {
            System.out.println(e);
            System.out.println
        ...
        s = Oppgave7.flett("AM ", "L", "GEDS", "ORATKRR", "", "R TRTE", "IO", "TGAUU");
        ...
        s = Oppgave7.flett("AFK", "BGLP", "CHMQT", "DINRUW", "EJOSVXY");
