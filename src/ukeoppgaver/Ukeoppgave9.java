...
public class Ukeoppgave9 {
    ...
    /*-------5.2.3-------*/
    /*Delopg3
    String[] s = {"I","E","O","A","G","M","C","F","H","K","N","B","D","J","L"};

    SBinTre tre1 = SBinTre.sbintre(Stream.of(s));
    System.out.println(tre1);
    System.out.println(tre1.høyde() + " " + tre1.antall());

    Integer[] a = {8,2,10,1,6,9,14,4,7,12,15,3,5,11,13};
    SBinTre tre2 = SBinTre.sbintre(Stream.of(a));
    System.out.println(tre2);
    System.out.println(tre2.høyde() + " " + tre2.antall());
     */
  ...
  System.out.println(treF);
    ...
    /*Delopg3
    Minimumsgrenen: 1 3 6 10 14
     */

    /*Delopg4
    Maksimumsgrenen: 12 11 9 5
     */
